...
Per garantire la robustezza, l'albero implementa un metodo interno \texttt{\_validate(p)} che controlla se una data posizione è valida prima di usarla. Una posizione è considerata valida se:
\begin{itemize}
