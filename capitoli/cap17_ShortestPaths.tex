...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{immagini/ShortestPath/ex_dijkstra2.png}
    \label{fig:ex_dijkstra2}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{immagini/ShortestPath/ex_dijkstra3.png}
    \label{fig:ex_dijkstra3}
\end{figure}
