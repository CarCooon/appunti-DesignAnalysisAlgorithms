...
\begin{itemize}
    \item La ricerca ha una complessità di $O(f(d) \log n / (\log d - 1))$.
    \item L'inserimento e la cancellazione hanno una complessità di $O(g(d) \log n / (\log d - 1))$.
\end{itemize}
